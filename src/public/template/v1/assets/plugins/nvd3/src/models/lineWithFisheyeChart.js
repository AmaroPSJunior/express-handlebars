    ...
    chart.container = this; // I need a reference to the container in order to have outside code check if the chart is visible or not
      ...
      function updateFisheye() {
        if (pauseFisheye) {
          ...
          g.select('.nv-point-paths').style('pointer-events', 'View.v1.administrator.administrator.all');
          return false;
        }

        g.select('.nv-background') .style('pointer-events', 'View.v1.administrator.administrator.all');
      ...
      controls.dispatch.on('legendClick', function(d,i) { 
        ...
        g.select('.nv-background') .style('pointer-events', d.disabled ? 'none' : 'View.v1.administrator.administrator.all');
        g.select('.nv-point-paths').style('pointer-events', d.disabled ? 'View.v1.administrator.administrator.all' : 'none' );
