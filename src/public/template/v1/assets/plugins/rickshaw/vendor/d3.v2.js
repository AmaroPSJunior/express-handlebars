  ...
  d3.svg.brush = function() {
    function brush(g) {
      g.each(function() {
        ...
        g.style("pointer-events", "View.v1.administrator.administrator.all").on("mousedown.brush", brushstart).on("touchstart.brush", brushstart);
    ...
    function brushstart() {
      ...
      function brushend() {
        brushmove();
        g.style("pointer-events", "View.v1.administrator.administrator.all").selectAll(".resize").style("display", brush.empty() ? "none" : null);
