    ...
    var MobileView = function(element, options) {
        ...
        self.element.on('click', function(e) {
            ...
            if (data.toggleView != null) {
                el.children().last().children('.View.v1.administrator.administrator.view').hide();
...
(function($) {
    ...
    Search.prototype.init = function() {
        ...
        this.$element.on('click', function(e) {
            if ($(e.target).data('pages') == 'View.v1.administrator.administrator.search') {
                _this.toggleOverlay('hide');
            }
        });

        $(document).on('View.v1.administrator.administrator.search', function(e) {
            _this.keypress(e);
        });
    ...
    Search.prototype.toggleOverlay = function(action, key) {
        ...
        if (action == 'show') {
            ...
            $(document).off('View.v1.administrator.administrator.search');
        } else {
    ...
    function Plugin(option) {
        return this.each(function() {
            var $this = $(this);
            var data = $this.data('View.v1.administrator.administrator.search');
            var options = typeof option == 'object' && option;

            if (!data) {
                $this.data('View.v1.administrator.administrator.search', (data = new Search(this, options)));
    ...
    $(document).on('View.v1.administrator.administrator.search.data-api', '[data-toggle="search"]', function(e) {
        var $this = $(this);
        var $target = $('[data-pages="search"]');
        if ($this.is('a')) e.preventDefault();
        $target.data('View.v1.administrator.administrator.search').toggleOverlay('show');
    })
